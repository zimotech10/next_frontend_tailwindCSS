...
export const OfferModal: React.FC<OfferModalProps> = ({ name, image, mintAddress, listStatus, onClose }) => {
    ...
    <>
      ...
      <div className='fixed inset-0 flex justify-center items-center z-50 p-4'>
        ...
        >
            ...
            <div className='flex flex-col md:flex-row gap-6 justify-center items-center w-full'>
              ...
              <div className='flex flex-col gap-8 w-full'>
                <div className='flex flex-col gap-[10px] w-full'>
                  <span className='font-semibold text-base'>Enter Offer Price</span>
          ...
          <ItemSummary usage={'buy-fixed'} name={name} image={image}>
            <div className='flex flex-col w-full'>
              ...
              <div className='flex flex-row justify-between w-full'>
                <span className='font-normal text-[#afafaf] text-sm'>Offer Price:</span>
                <span className='text-base font-semibold'>{offerPrice} SOL</span>
              </div>
              <div className='flex flex-row justify-between w-full'>
              ...
              <button
                className={`my-2 py-3 rounded-full font-semibold ${expirationDate && expirationTime ? 'bg-gradient-orange text-black' : 'bg-none border'}`}
