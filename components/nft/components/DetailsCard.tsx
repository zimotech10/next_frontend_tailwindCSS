...
import { acceptBuy, cancelBuy, instantBuy, unlisting } from '@/web3/contract';
...
export const DetailsCard = (
  ...
  const handleAcceptOffer = async (id: number) => {
    try {
      ...
      const seller = wallet;
      const tx = await acceptBuy(program, buyer, seller as AnchorWallet, authority, treasuryMint, nftMint, creators);
