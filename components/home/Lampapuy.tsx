...
const electronicaOutline = localFont({
  src: '../../fonts/electronica-display-2.otf',
});
...
const Lampapuy = () => {
  ...
  return (
    <div
      className='flex flex-col bg-black text-center mt-14 px-4'
      id='lampapuy'
    >
      <div className='flex items-center justify-center'>
        <h1
          className={`text-[78px] sm:text-[5rem] uppercase text-[#F5F5F5] z-20 opacity-40 -mb-12 ${electronicaOutline.className}`}
        >
      ...
      <div className='pt-0 z-10'>
        <div
          ...
          style={{
            background:
              'linear-gradient(140deg, #FFEA7F 9.83%, #AB5706 95.76%)',
