...
const electronica = localFont({ src: '../../fonts/Electronica-Display-Solid.otf' });
const forma = localFont({ src: '../../fonts/forma-djr-banner/FormaDJRBanner-Regular-Testing.ttf' });
