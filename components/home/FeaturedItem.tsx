...
const FeaturedCard: React.FC<Collection> = ({
  name,
  logoImage,
  coverImage,
  description,
  ...
  const coverImgHeight =
    gridType === 1
      ...
      ? '70px'
      : '167px';
  const coverImgWidthSize =
    gridType === 1 ? (isMobile ? 163 : 220) : isMobile ? 163 : 396;
  const coverImgHeightSize =
    gridType === 1 ? (isMobile ? 70 : 130) : isMobile ? 70 : 167;
  const profileImgSize =
    gridType === 1 ? (isMobile ? 34 : 40) : isMobile ? 34 : 81;
  const profileImg =
    gridType === 1 ? (isMobile ? '34px' : '40px') : isMobile ? '34px' : '81px';
